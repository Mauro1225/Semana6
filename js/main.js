...
let contePrincipal = document.getElementById("contenido");

listaPlatillos.forEach(function(platillo){
    
    let divTarjeta = document.createElement("div");
    divTarjeta.classList.add("tarjeta");
    contePrincipal.appendChild(divTarjeta);
    ...
    imagenIMG.setAttribute("src",platillo.imagen);
    divImagen.appendChild(imagenIMG);
    ...
    divTarjeta.appendChild(divPrecio);
    divPrecio.innerHTML =
        `<span>${platillo.precio} Soles</span>
